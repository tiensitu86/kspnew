...
const
 ...
 // Added for multi-channel WMA files
  WMA_CM_3Ch = 3;
  WMA_CM_4Ch = 4;
  WMA_CM_5Ch = 5;
  WMA_CM_5Dot1Ch = 6;
  { Channel mode names }
  WMA_MODE: array [0..6] of string = ('Unknown', 'Mono', 'Stereo', '3Ch', '4Ch', '5Ch', '5.1Ch');
...
begin
  ...
  Result :=
    ...
    (Data.Channels in [WMA_CM_MONO, WMA_CM_STEREO, WMA_CM_3Ch,
                                WMA_CM_4Ch, WMA_CM_5Ch, WMA_CM_5Dot1Ch])
