 ...
 *)
  ...
  ['{a88e5a60-205a-4bb1-94e1-2628daf51eae}']
    ...
    procedure CreateInstanceByContractID(const aContractID: PAnsiChar; aDelegate: nsISupports_safe19; const aIID: TGUID; out _result); safecall;
  end;
  ...
  ['{2417cbfe-65ad-48a6-b4b6-eb84db174392}']
    ...
    procedure RegisterFactory(const aClass: TGUID; const aClassName: PAnsiChar; const aContractID: PAnsiChar; aFactory: nsIFactory_safe19); safecall;
    procedure UnregisterFactory(const aClass: TGUID; aFactory: nsIFactory_safe19); safecall;
    procedure RegisterFactoryLocation(const aClass: TGUID; const aClassName: PAnsiChar; const aContractID: PAnsiChar; aFile: nsIFile_safe19; const aLoaderStr: PAnsiChar; const aType: PAnsiChar); safecall;
    procedure UnregisterFactoryLocation(const aClass: TGUID; aFile: nsIFile_safe19); safecall;
  ...
  ['{00000001-0000-0000-c000-000000000046}']
    procedure CreateInstance(aOuter: nsISupports_safe19; const iid: TGUID; out _result); safecall;
  ...
  ['{7392d032-5371-11d3-994e-00805fd26fee}']
    procedure GetClassObject(aCompMgr: nsIComponentManager_safe19; const aClass: TGUID; const aIID: TGUID; out aResult); safecall;
  ...
  ['{56c35506-f14b-11d3-99d3-ddbfac2ccf65}']
    ...
    procedure SetComplexValue(const aPrefName: PAnsiChar; const aType: TGUID; aValue: nsISupports_safe19); safecall;
  ...
  ['{69e5df00-7b8b-11d3-af61-00a024ffc08c}']
    procedure AddWebBrowserListener(aListener: nsIWeakReference_safe19; const aIID: TGUID); safecall;
    procedure RemoveWebBrowserListener(aListener: nsIWeakReference_safe19; const aIID: TGUID); safecall;
